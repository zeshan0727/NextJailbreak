...
static NSDictionary *NAHIDPastePayload(void) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.13",
        @"path": @"springboard_iohid_v0713_cmd_v"
    };
}
...
static NSDictionary *NAHIDTypeTextPayload(NSString *text) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.13",
        @"path": @"springboard_iohid_v0713_direct_text",
        @"typed_characters": @(typed)
    };
}
...
- (void)ensureSystemHUD {
    ...
    @try {
        ...
        Class hudViewControllerClass = NSClassFromString(@"SBHUDViewController");
        if (!workspaceClass || !hudViewControllerClass) {
        ...
        if (!hudController || ![hudController respondsToSelector:sessionSelector]) {
            self.systemHUDAvailable = NO;
            return;
        }

        UIViewController *controller = ((id (*)(id, SEL))objc_msgSend)(
            ((id (*)(id, SEL))objc_msgSend)((id)hudViewControllerClass, @selector(alloc)),
            @selector(init)
        );
        if (!controller) {
            self.systemHUDAvailable = NO;
        ...
        // SBHUDViewController is the native class expected by SpringBoard's
        // _SBHUDHostViewController. Using a plain UIViewController (0.7.12)
        // could create a model but never produce a visible HUD on iOS 16.
        ...
        id session = ((id (*)(id, SEL, id, id))objc_msgSend)(
            ...
            sessionSelector,
            controller,
            @"uk.zeshanbarvi.nextagent.status.v0713"
        );
        if (!session) {
            self.systemHUDAvailable = NO;
            return;
        ...
        self.systemHUDPill = nil;
        self.systemHUDTitle = nil;
        self.systemHUDIcon = nil;
        self.systemHUDSpinner = nil;
...
- (NSDictionary *)hudStatusPayload {
    ...
    return @{
        ...
        @"status_surface_generation": @"native_sbhud_v0713"
    };
}
...
- (NSDictionary *)directCapturePayload {
    ...
    if (!image) {
        return @{
            ...
            @"transport_version": @"0.7.13-cfmessageport1"
        };
    }
...
- (NSDictionary *)directOCRPayloadFast:(BOOL)fast
    ...
    if (!image || !image.CGImage) {
        return @{
            ...
            @"quality": quality ?: @{},
            @"error": @"SpringBoard compositor did not return a validated frame",
            @"transport_version": @"0.7.13-springboard-vision1"
        };
    }
...
- (NSDictionary *)close {
    ...
    self.opening = NO;
    self.lastOpenResult = nil;
    return @{@"success": @YES, @"active": @NO, @"bridge_version": @"0.7.13"};
}
...
static CFStringRef const NABridgeServiceName =
    CFSTR("uk.zeshanbarvi.nextagent.bridge.v0713");
    ...
    @autoreleasepool {
        ...
        if ([action isEqualToString:@"ping"]) {
            return NABridgeReply(@{
                ...
                @"hid": @"springboard_iohid_v0713",
                @"hud": @"native_sbhud_v0713"
            });
        }
