...
static NSString * const NASpringBoardHUDStatusPath = @"/var/mobile/Library/NextAgent/statushud.springboard.json";
...
static NSDictionary *NAHIDPastePayload(void) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.19",
        @"path": @"springboard_iohid_v0719_cmd_v"
    };
}
...
static NSDictionary *NAHIDTypeTextPayload(NSString *text) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.19",
        @"path": @"springboard_iohid_v0719_direct_text",
        @"typed_characters": @(typed)
    };
}
...
- (void)ensureSystemHUD {
    ...
    @try {
        ...
        id session = ((id (*)(id, SEL, id, id))objc_msgSend)(
            ...
            sessionSelector,
            controller,
            @"uk.zeshanbarvi.nextagent.status.v0719"
        );
        if (!session) {
            self.systemHUDAvailable = NO;
...
- (NSDictionary *)hudStatusPayload {
    ...
    NSDictionary *appHUD = NAReadJSON(NAHUDAppStatusPath);
    NSDictionary *externalHUD = NAReadJSON(NAHUDExternalStatusPath);
    NSDictionary *springBoardHUD = NAReadJSON(NASpringBoardHUDStatusPath);
    BOOL appTweakLoaded = [appHUD[@"loaded"] boolValue] &&
        [appHUD[@"generation"] isEqualToString:@"system_status_hud_v0718"];
    BOOL appWindowReady = [appHUD[@"window_ready"] boolValue];
    BOOL appWindowVisible = [appHUD[@"window_visible"] boolValue];

    return @{
        @"success": @(self.systemHUDAvailable || appTweakLoaded),
        @"bridge_version": @"0.7.19",
        @"tweak_loaded": @(appTweakLoaded),
        @"tweak_window_ready": @(appWindowReady),
        @"tweak_window_visible": @(appWindowVisible),
        @"tweak_generation": appHUD[@"generation"] ?: @"",
        @"tweak_scope": appHUD[@"scope"] ?: @"",
        @"tweak_bundle": appHUD[@"bundle"] ?: @"",
        @"tweak_constructor": appHUD[@"constructor"] ?: @"",
        @"tweak_startup_stage": appHUD[@"startup_stage"] ?: @"",
        @"tweak_bootstrap_reason": appHUD[@"bootstrap_reason"] ?: @"",
        @"tweak_bootstrap_attempts": appHUD[@"bootstrap_attempts"] ?: @0,
        @"tweak_bootstrap_finished": appHUD[@"bootstrap_finished"] ?: @NO,
        @"tweak_bootstrap_timed_out": appHUD[@"bootstrap_timed_out"] ?: @NO,
        @"tweak_application_available": appHUD[@"application_available"] ?: @NO,
        @"tweak_scene_ready": appHUD[@"scene_ready"] ?: @NO,
        @"tweak_last_mode": appHUD[@"mode"] ?: @0,
        @"external_tweak_status": externalHUD ?: @{},
        @"springboard_hud_tweak_loaded": @([springBoardHUD[@"loaded"] boolValue]),
        @"springboard_hud_generation": springBoardHUD[@"generation"] ?: @"",
        @"springboard_hud_host_found": @([springBoardHUD[@"host_found"] boolValue]),
        @"springboard_hud_view_ready": @([springBoardHUD[@"view_ready"] boolValue]),
        @"springboard_hud_visible": @([springBoardHUD[@"visible"] boolValue]),
        @"springboard_hud_host_window_class": springBoardHUD[@"host_window_class"] ?: @"",
        @"springboard_hud_host_view_class": springBoardHUD[@"host_view_class"] ?: @"",
        @"springboard_hud_failure": springBoardHUD[@"failure"] ?: @"",
        ...
        @"status_surface_generation": @"native_sbhud_v0719+tweak_v0718",
        @"hud_failure_stage": self.hudFailureStage ?: @"",
        @"hud_failure_detail": self.hudFailureDetail ?: @"",
        @"foreground_hud_fallback_expected": @YES,
        @"foreground_hud_fallback_path": @"/usr/lib/TweakInject/NextAgentStatusHUDApp0718.dylib"
    };
}
...
- (NSDictionary *)directCapturePayload {
    ...
    if (!image) {
        return @{
            ...
            @"transport_version": @"0.7.19-cfmessageport1"
        };
    }
...
- (NSDictionary *)directOCRPayloadFast:(BOOL)fast
    ...
    if (!image || !image.CGImage) {
        return @{
            ...
            @"quality": quality ?: @{},
            @"error": @"SpringBoard compositor did not return a validated frame",
            @"transport_version": @"0.7.19-springboard-vision1"
        };
    }
...
- (NSDictionary *)close {
    ...
    self.opening = NO;
    self.lastOpenResult = nil;
    return @{@"success": @YES, @"active": @NO, @"bridge_version": @"0.7.19"};
}
...
static CFStringRef const NABridgeServiceName =
    CFSTR("uk.zeshanbarvi.nextagent.bridge.v0719");
...
static CFDataRef NABridgeCallback(
    ...
    @autoreleasepool {
        ...
        if ([action isEqualToString:@"hud_test"]) {
            NABroadcastHUDState(@"working", @"HUD test", 0.42);
            dispatch_after(
                dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.2 * NSEC_PER_SEC)),
                dispatch_get_main_queue(),
                ^{
                    NABroadcastHUDState(@"complete", @"HUD test complete", 1.0);
                }
            );
            return NABridgeReply(@{
                @"success": @YES,
                @"bridge_version": @"0.7.19",
                @"test": @"hud_state_broadcast",
        ...
        if ([action isEqualToString:@"ping"]) {
            return NABridgeReply(@{
                ...
                @"split_workspace": @"explicit_only_target_scene_overlay_50_50",
                @"hid": @"springboard_iohid_v0719",
                @"hud": @"native_sbhud_v0719+roothide_tweak_v0718"
            });
        }
...
static void NAOverlayInit(void) {
    @autoreleasepool {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            // v0.7.16: never preserve a stale split window across respring/package upgrade.
            [[NASplitWorkspaceController shared] close];
