...
- (void)ensureUI {
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [pill.widthAnchor constraintGreaterThanOrEqualToConstant:166.0],
        [pill.widthAnchor constraintLessThanOrEqualToConstant:224.0],
...
- (void)refresh {
    ...
    if (self.lastTerminalState != packed) {
        ...
        self.lastTerminalDate = [NSDate date];
               ...
               [[NSDate date] timeIntervalSinceDate:self.lastTerminalDate] > 2.2) {
        [self hide];
        return;
    }
...
static void NAForegroundHUDInit(void) {
    @autoreleasepool {
        ...
        if ([bundle isEqualToString:@"com.apple.springboard"] ||
            [bundle isEqualToString:@"uk.zeshanbarvi.nextagent"]) {
            return;
        }
