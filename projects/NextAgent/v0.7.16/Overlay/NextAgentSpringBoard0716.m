...
static NSDictionary *NAHIDPastePayload(void) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.16",
        @"path": @"springboard_iohid_v0716_cmd_v"
    };
}
...
static NSDictionary *NAHIDTypeTextPayload(NSString *text) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.16",
        @"path": @"springboard_iohid_v0716_direct_text",
        @"typed_characters": @(typed)
    };
}
...
- (void)ensureSystemHUD {
    ...
    @try {
        ...
        id session = ((id (*)(id, SEL, id, id))objc_msgSend)(
            ...
            sessionSelector,
            controller,
            @"uk.zeshanbarvi.nextagent.status.v0716"
        );
        if (!session) {
            self.systemHUDAvailable = NO;
...
- (NSDictionary *)hudStatusPayload {
    ...
    return @{
        ...
        @"status_surface_generation": @"native_sbhud_v0716",
        @"hud_failure_stage": self.hudFailureStage ?: @"",
        @"hud_failure_detail": self.hudFailureDetail ?: @"",
        @"foreground_hud_fallback_expected": @YES,
        @"foreground_hud_fallback_path": @"/usr/lib/TweakInject/NextAgentStatusHUD0716.dylib"
    };
}
...
- (NSDictionary *)directCapturePayload {
    ...
    if (!image) {
        return @{
            ...
            @"transport_version": @"0.7.16-cfmessageport1"
        };
    }
...
- (NSDictionary *)directOCRPayloadFast:(BOOL)fast
    ...
    if (!image || !image.CGImage) {
        return @{
            ...
            @"quality": quality ?: @{},
            @"error": @"SpringBoard compositor did not return a validated frame",
            @"transport_version": @"0.7.16-springboard-vision1"
        };
    }
...
- (NSDictionary *)close {
    ...
    self.opening = NO;
    self.lastOpenResult = nil;
    return @{@"success": @YES, @"active": @NO, @"bridge_version": @"0.7.16"};
}
...
static CFStringRef const NABridgeServiceName =
    CFSTR("uk.zeshanbarvi.nextagent.bridge.v0716");
    ...
    @autoreleasepool {
        ...
        if ([action isEqualToString:@"ping"]) {
            return NABridgeReply(@{
                ...
                @"hid": @"springboard_iohid_v0716",
                @"hud": @"native_sbhud_v0716"
            });
        }
