...
static NSDictionary *NAHIDPastePayload(void) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.14",
        @"path": @"springboard_iohid_v0714_cmd_v"
    };
}
...
static NSDictionary *NAHIDTypeTextPayload(NSString *text) {
    ...
    return @{
        @"success": @YES,
        @"bridge_version": @"0.7.14",
        @"path": @"springboard_iohid_v0714_direct_text",
        @"typed_characters": @(typed)
    };
}
...
- (void)ensureSystemHUD {
    ...
    @try {
        ...
        id session = ((id (*)(id, SEL, id, id))objc_msgSend)(
            ...
            sessionSelector,
            controller,
            @"uk.zeshanbarvi.nextagent.status.v0714"
        );
        if (!session) {
            self.systemHUDAvailable = NO;
...
- (NSDictionary *)hudStatusPayload {
    ...
    return @{
        ...
        @"status_surface_generation": @"native_sbhud_v0714",
...
- (NSDictionary *)directCapturePayload {
    ...
    if (!image) {
        return @{
            ...
            @"transport_version": @"0.7.14-cfmessageport1"
        };
    }
...
- (NSDictionary *)directOCRPayloadFast:(BOOL)fast
    ...
    if (!image || !image.CGImage) {
        return @{
            ...
            @"quality": quality ?: @{},
            @"error": @"SpringBoard compositor did not return a validated frame",
            @"transport_version": @"0.7.14-springboard-vision1"
        };
    }
...
- (NSDictionary *)close {
    ...
    self.opening = NO;
    self.lastOpenResult = nil;
    return @{@"success": @YES, @"active": @NO, @"bridge_version": @"0.7.14"};
}
...
static CFStringRef const NABridgeServiceName =
    CFSTR("uk.zeshanbarvi.nextagent.bridge.v0714");
    ...
    @autoreleasepool {
        ...
        if ([action isEqualToString:@"ping"]) {
            return NABridgeReply(@{
                ...
                @"hid": @"springboard_iohid_v0714",
                @"hud": @"native_sbhud_v0714"
            });
        }
