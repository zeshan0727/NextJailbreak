...
static NSString * const NAForegroundHUDGeneration = @"foreground_app_hud_v0714";
...
- (NSString *)labelForDetail:(uint64_t)detail {
    switch (detail) {
        ...
        default: return [NSString stringWithFormat:@"Next Agent • Working"]; // foreground_app_hud_v0714
    }
}
